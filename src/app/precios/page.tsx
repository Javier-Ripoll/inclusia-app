...
const COMPANY_PLANS = [
  {
    ...
    price: '49',
    period: 'mes',
    description: 'Para necesidades puntuales',
    features: [
      { text: 'Publicar ofertas ilimitadas', included: true },
      { text: 'Acceso a base de candidatos', included: true },
      { text: 'Filtros: ubicación, formación, experiencia', included: true },
      { text: 'Recepción de candidaturas', included: true },
      { text: 'Contacto directo con profesionales', included: true },
      { text: 'Candidatos disponibles ahora', included: false },
      { text: 'Matching automático con IA', included: false },
      { text: 'Ofertas urgentes con prioridad', included: false },
      { text: 'Chat directo integrado', included: false },
      { text: 'Dashboard de contratación', included: false },
      { text: 'Cobertura urgente automática', included: false },
      { text: 'Multi-centro', included: false },
    ],
    cta: 'Empezar con Básico',
    href: '/auth/registro?rol=empresa&plan=basic',
    variant: 'outline' as const,
    highlight: false,
  },
  {
    ...
    price: '99',
    period: 'mes',
    description: 'Para empresas con contratación frecuente',
    badge: 'Recomendado',
    features: [
      { text: 'Publicar ofertas ilimitadas', included: true },
      { text: 'Acceso a base de candidatos', included: true },
      ...
      { text: 'Recepción de candidaturas', included: true },
      { text: 'Contacto directo con profesionales', included: true },
      { text: 'Candidatos disponibles ahora', included: true },
      { text: 'Matching automático con IA', included: true },
      { text: 'Ofertas urgentes con prioridad', included: true },
      { text: 'Chat directo integrado', included: true },
      { text: 'Dashboard de contratación', included: true },
      { text: 'Cobertura urgente automática', included: false },
      { text: 'Multi-centro', included: false },
    ],
    cta: 'Empezar con Pro',
  ...
  },
  {
    ...
    price: '149',
    period: 'mes',
    description: 'Para grandes entidades que necesitan rapidez constante',
    features: [
      { text: 'Publicar ofertas ilimitadas', included: true },
      { text: 'Acceso a base de candidatos', included: true },
      { text: 'Filtros: ubicación, formación, experiencia', included: true },
      ...
      { text: 'Chat directo integrado', included: true },
      { text: 'Dashboard de contratación', included: true },
      { text: 'Cobertura urgente automática', included: true },
      { text: 'Multi-centro (hasta 10 centros)', included: true },
    ],
