...
const PROFESSIONAL_PLANS = [
  {
    ...
    features: [
      ...
      { text: 'Aplicar a ofertas estándar', included: true },
      { text: 'Ver ofertas urgentes (con retraso)', included: true },
      { text: 'Chat con centros', included: true },
      { text: 'Hasta 5 candidaturas activas', included: true },
      { text: 'Alertas instantáneas de ofertas urgentes', included: false },
      { text: 'Acceso prioritario antes que otros profesionales', included: false },
      { text: 'Candidaturas ilimitadas', included: false },
      { text: 'Destacado en búsquedas de centros', included: false },
      { text: 'Insignia Premium visible en tu perfil', included: false },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Chat con centros', included: true },
      { text: 'Hasta 5 candidaturas activas', included: true },
      { text: 'Alertas instantáneas de ofertas urgentes', included: true },
      { text: 'Acceso prioritario antes que otros profesionales', included: true },
      { text: 'Candidaturas ilimitadas', included: true },
      { text: 'Destacado en búsquedas de centros', included: true },
      { text: 'Insignia Premium visible en tu perfil', included: true },
    ],
    cta: 'Activar Premium',
...
const COMPANY_PLANS = [
  {
    ...
    features: [
      ...
      { text: 'Notificaciones a profesionales de la zona', included: false },
      { text: 'Candidatos disponibles ahora destacados', included: false },
      { text: 'Estadísticas de candidaturas', included: false },
      { text: 'Gestión de equipo (altas, datos, nóminas)', included: false },
      { text: 'Gestor de equipo dedicado', included: false },
    ],
    cta: 'Crear cuenta gratis',
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Notificaciones a profesionales de la zona', included: true },
      { text: 'Candidatos disponibles ahora destacados', included: true },
      { text: 'Estadísticas de candidaturas', included: true },
      { text: 'Gestión de equipo (altas, datos, nóminas)', included: true },
      { text: 'Gestor de equipo dedicado', included: false },
    ],
    cta: 'Empezar con Pro',
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Candidatos disponibles ahora destacados', included: true },
      { text: 'Estadísticas de candidaturas', included: true },
      { text: 'Gestión de equipo avanzada', included: true },
      { text: 'Gestor de equipo dedicado', included: true },
    ],
