        ...
        <div style="font-family:sans-serif;max-width:600px;margin:0 auto;">
          ...
          <div style="background:#f9fafb;padding:24px;border-radius:0 0 8px 8px;border:1px solid #e5e7eb;">
            <table style="width:100%;border-collapse:collapse;">
              ...
              ${tipo ? `<tr><td style="padding:8px 0;color:#6b7280;font-size:14px;">Tipo</td><td style="padding:8px 0;">${tipo}</td></tr>` : ''}
            </table>
            ...
            <p style="color:#9ca3af;font-size:12px;margin:16px 0 0;">Enviado desde inclusiajobs.com · Reply-To: ${email}</p>
          </div>
        </div>
      `,
    })
